...
const testimonials = [
  {
    name: 'Jane Doe',
    feedback:
      'Client Nest has streamlined our social media management. Highly recommended!',
...
const features = [
  ...
  },
  {
    ...
    description:
      'Track engagement, growth, and performance with real-time analytics.',
    icon: (
      <svg
        className="w-8 h-8 text-primary"
        fill="none"
...
export default function LandingPage() {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen flex flex-col scroll-smooth">
      ...
      <section className="relative flex flex-col items-center justify-center py-20 px-4 text-center shadow-sm min-h-[400px]">
        ...
        <div className="relative z-20 max-w-2xl mx-auto flex flex-col items-center justify-center min-h-[400px]">
          <h1 className="text-6xl font-extrabold mb-4 text-white drop-shadow-lg">
            Welcome to Client Nest
          </h1>
          <p className="text-2xl text-white/90 mb-8 drop-shadow">
            The all-in-one platform to manage, analyze, and grow your social
            media presence.
          </p>
          <Button
            size="lg"
      ...
      <section
        id="features"
        className="py-16 px-4 bg-gradient-to-r from-white to-blue-50"
      >
        <h2 className="text-3xl font-bold text-center mb-10">
          Why Choose Client Nest?
        </h2>
      ...
      <section
        id="pricing"
        className="py-16 px-4 bg-gradient-to-r from-white to-indigo-50"
      >
        <h2 className="text-3xl font-bold text-center mb-10">
        ...
        <div className="text-center mt-8">
          <a
            href="/pricing"
            className="inline-block text-primary font-semibold hover:underline hover:text-blue-600 transition-colors duration-200 text-lg"
          >
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-blue-50 to-white">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map(t => (
            <Card
              key={t.name}
              className="hover:shadow-lg transition-shadow flex flex-col justify-between h-full items-center text-center p-6"
            >
              <img
                src={t.img}
                alt={t.name}
              ...
              <CardHeader className="p-0">
                ...
                <span className="inline-block text-xs text-muted-foreground bg-muted px-3 py-1 rounded-full mb-4">
                  {t.role}
                </span>
              </CardHeader>
              <CardContent className="text-muted-foreground italic p-0">
                “{t.feedback}”
              </CardContent>
            </Card>
          ))}
      ...
      <section className="py-16 px-4 bg-primary text-white text-center">
        ...
        <p className="text-lg mb-8">
          Join Client Nest today and take your social presence to the next
          level.
        </p>
        <Button
          size="lg"
