...
import { Search, Filter, MessageCircle, Heart, Reply, MoreHorizontal } from "lucide-react";
...
const CommentsPage = () => {
  ...
  const comments = [
    ...
    },
    {
      ...
      content: "Interesting points, but I think you missed the impact of AI on customer service.",
      author: "Alex Rivera",
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-sm text-muted-foreground">{comment.platform}</span>
                  </div>
